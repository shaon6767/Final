...
const Category = () => {
  ...
  const settings = {
    ...
    infinite: true,
    speed: 500,
    slidesToShow: window.innerWidth < 640 ? 2 : window.innerWidth < 768 ? 3 : window.innerWidth < 1024 ? 3 : 4,
    slidesToScroll: window.innerWidth < 640 ? 2 : window.innerWidth < 768 ? 2 : window.innerWidth < 1024 ? 2 : 2,
